...
_plot = service_by_category.sort_values("on_time_rate", ascending=True)
fig, ax = plt.subplots(figsize=(9,4))
ax.barh(_plot["prodCategory"].astype(str), _plot["on_time_rate"]*100)
ax.set_xlabel("On-time %")
ax.set_ylabel("Product Category")
ax.set_title("On-time Delivery by Category")
for i, v in enumerate((_plot["on_time_rate"]*100).round(1)):
    ax.text(float(v) + 0.5, i, f"{v:.1f}%", va="center")
plt.tight_layout()
```
